...
function calc() {
  ...
  var sex, height, age, weight, ratio;
  ...
  var initLocalStorage = function initLocalStorage(selector, activeClass) {
...
function cards() {
  ...
  var Card = /*#__PURE__*/function () {
    function Card(src, alt, title, descr, price, parentSelector) {
    ...
    _createClass(Card, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          ...
          this.classes.forEach(function (classList) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResource)('http://localhost:3000/menu').then(function (data) {
...
function form(modalSelector, modalTimerId, formSelector) {
  ...
  function postingData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var formMessage = document.createElement('img');
  ...
  function showThanksModal(message) {
    var modalWindow = document.querySelector('.modal__dialog');
    modalWindow.classList.add('hide');
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)(modalSelector, modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_8__.closeModal)(modalSelector);
    }, 4000);
  }
}
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  var btnModal = document.querySelectorAll(triggerSelector);
  var modalWindow = document.querySelector(modalSelector);
...
function slider(_ref) {
  var container = _ref.container,
    prevSlide = _ref.prevSlide,
    nextSlide = _ref.nextSlide,
    slidesCounter = _ref.slidesCounter,
    slidesCurrent = _ref.slidesCurrent,
    innerWrapper = _ref.innerWrapper,
    sliderWrapper = _ref.sliderWrapper,
    slideAll = _ref.slideAll;
  // Slider
  var slides = document.querySelectorAll(slideAll);
  var prev = document.querySelector(prevSlide);
  var next = document.querySelector(nextSlide);
  var total = document.querySelector(slidesCounter);
  var current = document.querySelector(slidesCurrent);
  var wrapperSlider = document.querySelector(sliderWrapper);
  var innerSlider = document.querySelector(innerWrapper);
  var width = window.getComputedStyle(wrapperSlider).width;
  ...
  var checkSlide = function checkSlide(slide) {
    if (slide < 10) {
  ...
  var dotOpacity = function dotOpacity() {
    dots.forEach(function (item) {
      return item.style.opacity = '.5';
    });
  ...
  next.addEventListener('click', function () {
    ...
    innerSlider.style.transform = "translateX(-".concat(offset, "px)");
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      var slideTo = e.target.getAttribute('data-slide');
      slideIndex = slideTo;
...
function tabs(tabsSelector, tabsContentSelector, tabParentSelector, activeClass) {
  ...
  var tabParent = document.querySelector(tabParentSelector);
  function hideTab() {
...
function timer(deadline, id) {
  ...
  function setClock(endtime, selector) {
    var timer = document.querySelector(".".concat(selector));
...
var postData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, obj) {
    var res;
...
document.addEventListener('DOMContentLoaded', function () {
  var modalTimer = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modalTimer);
  }, 50000);
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_3__["default"])('.modal', modalTimer, 'form');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('2022-12-31', 'timer');
